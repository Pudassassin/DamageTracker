...
namespace CardMagnifier.MonoBehaviors
{
    ...
    public class CardEnlarger : MonoBehaviour
    {
        ...
        {
            configPosInterpolateFactor = DamageTracker.CardToZoomPointFactor;
            configZoomToPos.x = DamageTracker.ZoomPointXOffset;
            configZoomToPos.y = DamageTracker.ZoomPointYOffset;

            configZoomScale = DamageTracker.ZoomScale;
            configZoomAbsoluteEnable = DamageTracker.ZoomToAbsoluteSize;
            configReorientCardEnable = DamageTracker.ReorientCard;

            configInterpolateTime = DamageTracker.ZoomTime;
            configDisableDiscardEffect = DamageTracker.DecreaseDiscardMotions;
            configDisableCardBobbingEffect = DamageTracker.DisableCardBobbingEffect;
            configDisableCardFlippingEffect = DamageTracker.DisableCardFlippingEffect;


            configCardBarPreviewPosition.x = DamageTracker.CardBarPreviewXOveride;
            configCardBarPreviewPosition.y = DamageTracker.CardBarPreviewYOveride;
            configCardBarPreviewScale = DamageTracker.CardBarPreviewScaleOveride;
        }
    ...
    public class CardEnlargerDemo : MonoBehaviour
    {
        ...
        public void Update()
        {
            isDemoCardZoomMode = DamageTracker.CardZoomDemoMode;
            isDemoCardBarPreviewMode = DamageTracker.CardBarPreviewDemoMode;
